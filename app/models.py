...
# usuario6 = Usuario(Nome='Juliana Freitas', Login='JF', Senha='123456')
# usuario7 = Usuario(Nome='André Silva', Login='AS', Senha='123456')
# usuario8 = Usuario(Nome='Higor dos Santos', Login='HS', Senha='123456')
# usuario9 = Usuario(Nome='Thomas Palma', Login='TP', Senha='123456')
# usuario10 = Usuario(Nome='Pedro Willian', Login='PW', Senha='123456')
# usuario11 = Usuario(Nome='Elias Ferreira', Login='EF', Senha='123456')
...
# equipe_sprint1 = EquipeSprint(IdEquipe=1, IdSprint=1, PontosPacer=45)
# equipe_sprint2 = EquipeSprint(IdEquipe=2, IdSprint=1, PontosPacer=63)
# equipe_sprint3 = EquipeSprint(IdEquipe=3, IdSprint=1, PontosPacer=38)
# equipe_sprint4 = EquipeSprint(IdEquipe=4, IdSprint=1, PontosPacer=25)
# equipe_sprint5 = EquipeSprint(IdEquipe=1, IdSprint=2, PontosPacer=65)
# equipe_sprint6 = EquipeSprint(IdEquipe=2, IdSprint=2, PontosPacer=63)
# equipe_sprint7 = EquipeSprint(IdEquipe=3, IdSprint=2, PontosPacer=?)
# equipe_sprint8 = EquipeSprint(IdEquipe=4, IdSprint=2, PontosPacer=?)
...
# session.commit()
# session.add(UsuarioEquipe(UsuarioId=1, EquipeId=1, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=2, EquipeId=1, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=3, EquipeId=1, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=4, EquipeId=1, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=5, EquipeId=2, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=6, EquipeId=2, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=7, EquipeId=2, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=8, EquipeId=2, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=9, EquipeId=2, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=10, EquipeId=2, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=11, EquipeId=2, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=12, EquipeId=3, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=13, EquipeId=3, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=14, EquipeId=3, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=15, EquipeId=3, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=16, EquipeId=3, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=17, EquipeId=4, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=18, EquipeId=4, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=19, EquipeId=4, Ativo = True))
# session.add(UsuarioEquipe(UsuarioId=20, EquipeId=4, Ativo = True))
# session.commit()

# # #Equipe Cluster8 Sprint 1
# # Avaliações do usuário 1 (Hariel)
# ch1 = UsuarioPacer(IdUsuario=1, IdUsuarioAvaliado=4, IdSprint=1, NotaP=3, NotaA=3, NotaC=3, NotaER=3)
# ch2 = UsuarioPacer(IdUsuario=1, IdUsuarioAvaliado=2, IdSprint=1, NotaP=3, NotaA=2, NotaC=3, NotaER=3)
# ch3 = UsuarioPacer(IdUsuario=1, IdUsuarioAvaliado=1, IdSprint=1, NotaP=3, NotaA=2, NotaC=3, NotaER=3)
# ch4 = UsuarioPacer(IdUsuario=1, IdUsuarioAvaliado=3, IdSprint=1, NotaP=3, NotaA=2, NotaC=3, NotaER=3)

# # Avaliações do usuário 2 (Hariel)
